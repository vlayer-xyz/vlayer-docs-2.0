...
[**vouch**](https://docs.getvouch.io/introduction) is a user-facing service that simplifies the process of generating web proofs. Instead of managing API calls directly, your application redirects users to vouch, which handles the proof generation and returns the verified data via a webhook. This provides:

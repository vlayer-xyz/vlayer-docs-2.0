...
* `version`: TLSN protocol version. Vouch-generated proofs use `"2.0.0"`
* `meta`: Metadata object
* `notaryUrl`: URL of the notary server used during proving (e.g. `"https://notary.production.vlayer.xyz/v2.0.0"`)

...
* `redaction`: Optional array of redaction rules for controlling which request headers are included in the Web Proof. Supports two modes:
...
This example demonstrates how to make an authenticated Gmail API request while redacting the sensitive Authorization header from the proof:

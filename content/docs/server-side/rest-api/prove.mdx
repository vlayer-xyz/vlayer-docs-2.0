...
* `redaction`: Optional array of redaction rules controlling which parts of the request and response are revealed in the Web Proof. Each rule targets `request` and/or `response`, and rules accumulate across the array.

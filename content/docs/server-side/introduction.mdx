...
* [POST /verify](/server-side/rest-api/verify) accepts a Web Proof, verifies it, and returns the parsed HTTP transcript.
* [POST /verify-batch](/server-side/rest-api/verify-batch) accepts up to 32 Web Proofs and returns one verification result per proof.

...
* [POST `/prove`](/docs/server-side/rest-api/prove) accepts an HTTPS request definition, notarizes the request, and returns a Web Proof.
* [POST `/verify`](/docs/server-side/rest-api/verify-web-proof) accepts a Web Proof, verifies it, and returns the parsed HTTP transcript.

...
```json
{
  ...
  "data": {
    ...
    "journalDecodeInfo": {
      ...
      "journalValues": ["0xa7e62d7f17aa7a22...", "\"GET\"", "\"https://data-api.binance.vision/api/v3/ticker/price?symbol=ETHUSDC\"", "1234567890", "0xe27c1b124a855f1f...", "\"3500.50\"", "\"ETHUSDC\""],
...
The `journalDecodeInfo` provides helpful information for decoding the `journalDataAbi`:
- **`solidityCodeSnippet`**: Ready-to-use Solidity code you can copy directly into your contract
- **`journalTypes`**: Array of Solidity types in the correct order
- **`journalValues`**: Actual values for debugging/verification
...
const zkProofResponse = {
  ...
  data: {
    ...
    journalDataAbi: '0xa7e62d7f17aa7a22c26bdb93b7ce9400e826ffb2c6f54e54d2ded015677499af...',
    journalDecodeInfo: {
      // ... decode info omitted for brevity
    }
  }
};

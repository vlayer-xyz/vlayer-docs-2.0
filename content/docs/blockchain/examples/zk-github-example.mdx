...
- **`ZK_PROVER_GUEST_ID`**: The RISC Zero guest program ID used by the ZK Prover Server. This identifies the specific program that generated the ZK proof and is required for on-chain verification. See the [guest-id endpoint documentation](/blockchain/rest-api/v2/guest-id) for details.

---
title: Tutorial - Fullstack GitHub ZK Prover
---
...
export ZK_PROVER_GUEST_ID=$(curl -s https://zk-prover.vlayer.xyz/api/v2.0/evm/guest-id | jq -r '.data.guestId')
...
ZK_PROVER_GUEST_ID="0xd4759baae1296d344b129ddd497a889760d5c2171ab98332a1427df0ffec6898" # Get latest from /api/v2.0/evm/guest-id endpoint
...
- Real network access plus the following environment variables (the test fails fast if any are missing):
  - `WEB_PROVER_API_SECRET` (vlayer credential)

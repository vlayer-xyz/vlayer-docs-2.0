...
<Callout type="info">
**Quick Start**: Call `/journal-decode-info` with the same request to get a `solidityCodeSnippet`! It provides ready-to-use Solidity code that you can copy directly into your contract for decoding the journal data.
</Callout>

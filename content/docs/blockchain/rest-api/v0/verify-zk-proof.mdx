...
* `publicOutputs`: Expected public outputs from the ZK proof
  ...
  * `queriesHash`: Expected hash of extraction queries (see [how is queries hash calculated](/blockchain/rest-api/v0/compress-web-proof#extraction-hash-calculation))

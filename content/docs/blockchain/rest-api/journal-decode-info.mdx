...
<Callout type="info">
This endpoint returns <code>journalDataAbi</code> along with decode helpers. Use this for development and testing to see decoded data before calling <code>/compress-web-proof</code> for production ZK proof generation.
</Callout>
